...
;(function( $, window, document, undefined ) {
    ...
    $.widget( widgetName, {
        ...
        _getDisableTargets : function() {
            ...
            if (form.length > 0)  // Disable all inputs if spinner is in a form
